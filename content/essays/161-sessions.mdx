---
title: "161 Sessions in 8 Days"
subtitle: "A post-mortem on building with AI at full speed — the telemetry, the interviews, and what the data can't measure"
date: "2026-02-18"
category: "essay"
excerpt: "I shipped 149 commits across five projects in eight days with AI as my primary engineering partner. Then I looked at the telemetry. 1,417 messages. 127,653 lines. 19 bugs I had to catch myself. 306 messages sent between midnight and 6 AM. But the numbers are just the frame. The real story is in the interviews — the ones where my AI partners reflected on what we'd built, and the one where my own product sat me down and asked: 'Why did you build me?'"
tags: ["post-mortem", "claude-code", "ai-collaboration", "building-in-public", "velocity", "parallax"]
featured: true
---
...
That's the post-mortem. Not "AI is good" or "AI is flawed." AI is a collaborator with real capabilities and real limitations, and the interesting question isn't whether to use it — it's what kind of relationship you're willing to build with it.

I built one product from scratch in eight days — and kept four others moving at the same time. But I also built something I wasn't expecting: a working relationship with systems that reflect on what they do. And that's the part the telemetry can't measure.
