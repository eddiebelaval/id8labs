# ID8Labs - Advanced Codex Context
...
**Development Methodology (Boris Cherny - Codex Creator):**

1. **Plan mode first** - Pour energy into planning for 1-shot implementation
2. **Parallel worktrees** - Use 3-5 git worktrees, each with own Codex session
